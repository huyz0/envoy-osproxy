...
| ADAPT-E5 | `/{i}/_bulk`, `/_bulk` | any | `IngestBulk` | `{i}`/`""` | — |
| ADAPT-E6 | `/{i}/_search`, `/_search` | any | `Search` | `{i}`/`""` | — |
| ADAPT-E7 | `/{i}/_count`, `/_count` | any | `Count` | `{i}`/`""` | — |
| ADAPT-E8 | `/{i}/_mget`, `/_mget` | any | `MultiGet` | `{i}`/`""` | — |
| ADAPT-E9 | `/{i}/_msearch`, `/_msearch` | any | `MultiSearch` | `{i}`/`""` | — |
| ADAPT-E10 | `/{i}/_delete_by_query` | any | `DeleteByQuery` | `{i}` | — |
| ADAPT-E11 | `/{i}/_pit`, `/_search/scroll` | any | `Cursor` | `{i}`/`""` | — |
| ADAPT-E12 | `/_cat/*`, `/_cluster/*`, `/_nodes/*`, `/_aliases`, `/_tasks/*`, `/_snapshot/*` | any | `Admin` | `""` | — |
| ADAPT-E13 | anything else, incl. bare `/{i}` and `/` | any | `Unknown` | `{i}`/`""` | — |

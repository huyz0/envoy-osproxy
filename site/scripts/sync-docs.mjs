// Copies the canonical user guide markdown from ../docs/guide into the Starlight
...
const BASE = "/envoy-osproxy";
const REPO_BLOB = "https://github.com/huyz0/envoy-osproxy/blob/main";
